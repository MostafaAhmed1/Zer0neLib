...
namespace Zer0ne.WinUI
{
     ...
     class FlatDateTimePicker : DateTimePicker
    {
        ...
        public FlatDateTimePicker()
        {
            ...
            DoubleBuffered = true;
            calendarImage = Properties.Resources.Calender_32px;
            calendarImageWhite = Properties.Resources.Calender_32px;
        }
        ...
        [DllImport("user32.dll")]
        static extern IntPtr SendMessage(IntPtr hWnd, int Msg,IntPtr wParam, ref DATETIMEPICKERINFO info);
        [DllImport("user32.dll")]
        static extern IntPtr SendMessage(IntPtr hWnd, int Msg,IntPtr wParam, IntPtr info);
